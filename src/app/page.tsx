      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center">
            <button className="bg-gradient-to-r from-red-600 to-red-500 text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg hover:shadow-red-500/50 transition transform hover:scale-105">
              Register Now
            </button>
            <button className="border-2 border-red-500 text-red-500 px-8 py-3 rounded-lg font-semibold hover:bg-red-500 hover:text-white transition">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section id="schedule" className="py-20 px-4 bg-opacity-50 bg-slate-800">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { time: 'Friday 6 PM', event: 'Check-in & Opening Ceremony', desc: 'Welcome to Hack the Clock!' },
